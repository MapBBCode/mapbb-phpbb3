...
$lang = array_merge($lang, array(
	...
	'MAPBB_SUBMITWARNING' => 'You will lose changes to the map. Proceed?',

	//share
	'MAPBB_EXPORT' => 'Export',
	'MAPBB_EXPORTTITLE' => 'Download this map',
	'MAPBB_UPLOAD' => 'Upload',
	'MAPBB_UPLOADTITLE' => 'Upload this map to an external server',
	'MAPBB_UPLOADING' => 'Uploading',
	'MAPBB_UPLOADERROR' => 'Error while uploading the map',
	'MAPBB_UPLOADSUCCESS' => 'Upload was successful. Bookmark this link to be able to edit the map',
	'MAPBB_SHAREDFORMHEADER' => 'There are no objects to upload. Enter a MapBBCode Share map URL',
	'MAPBB_SHAREDFORMERROR' => 'This map panel has incorrect endpoint set.<br>Please contact an administrator.',
	'MAPBB_SHAREDFORMINVALIDCODE' => 'Map code is invalid',
        'MAPBB_SHAREDCODELOADING' => 'Downloading <a href="{url}" target="mapbbcode_outer">a map</a>...',
	'MAPBB_SHAREDCODEERROR' => 'Failed to download an external map<br><br><a href="{url}" target="mapbbcode_outer">Open map in a new window</a>',
